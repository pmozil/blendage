...
static Key keys[] = {
	...
	{ MODKEY,                    ( xkb_keysym_t ) 'o',          incnmaster,     {.i = +1} },
	{ MODKEY,                    ( xkb_keysym_t ) 'p',          incnmaster,     {.i = -1} },
	{ MODKEY,                    ( xkb_keysym_t ) 'h',          setmfact,       {.f = -0.05} },
	{ MODKEY,                    ( xkb_keysym_t ) 'l',          setmfact,       {.f = +0.05} },
	{ MODKEY,                    ( xkb_keysym_t ) '\n',         zoom,           {0} },
	{ MODKEY,                    ( xkb_keysym_t ) '\t',         view,           {0} },
	{ MODKEY,                    ( xkb_keysym_t ) 'q',          killclient,     {0} },
	{ MODKEY|WLR_MODIFIER_SHIFT, ( xkb_keysym_t ) 'R',          setlayout,      {.v = &layouts[0]} },
	{ MODKEY|WLR_MODIFIER_SHIFT, ( xkb_keysym_t ) 'T',          setlayout,      {.v = &layouts[1]} },
	{ MODKEY|WLR_MODIFIER_SHIFT, ( xkb_keysym_t ) 'F',          setlayout,      {.v = &layouts[2]} },
	{ MODKEY|WLR_MODIFIER_SHIFT, ( xkb_keysym_t ) 'M',          setlayout,      {.v = &layouts[3]} },
	{ MODKEY,                    ( xkb_keysym_t ) ' ',          setlayout,      {0} },
	{ MODKEY|WLR_MODIFIER_SHIFT, ( xkb_keysym_t ) ' ',          togglefloating, {0} },
	{ MODKEY,                    ( xkb_keysym_t ) 'e',          togglefullscreen, {0} },
	{ MODKEY,                    ( xkb_keysym_t ) '0',          view,           {.ui = ~0} },
	{ MODKEY,                    ( xkb_keysym_t ) ',',          focusmon,       {.i = WLR_DIRECTION_LEFT} },
	{ MODKEY,                    ( xkb_keysym_t ) '.',          focusmon,       {.i = WLR_DIRECTION_RIGHT} },
	{ MODKEY|WLR_MODIFIER_SHIFT, ( xkb_keysym_t ) '<',          tagmon,         {.i = WLR_DIRECTION_LEFT} },
	{ MODKEY|WLR_MODIFIER_SHIFT, ( xkb_keysym_t ) '>',          tagmon,         {.i = WLR_DIRECTION_RIGHT} },
	TAGKEYS(          XKB_KEY_1, ( xkb_keysym_t ) '!',                     0),
	TAGKEYS(          XKB_KEY_2, ( xkb_keysym_t ) '@',                     1),
	TAGKEYS(          XKB_KEY_3, ( xkb_keysym_t ) '#',                     2),
	TAGKEYS(          XKB_KEY_4, ( xkb_keysym_t ) '$',                     3),
	TAGKEYS(          XKB_KEY_5, ( xkb_keysym_t ) '%',                     4),
	TAGKEYS(          XKB_KEY_6, ( xkb_keysym_t ) '^',                     5),
	TAGKEYS(          XKB_KEY_7, ( xkb_keysym_t ) '&',                     6),
	TAGKEYS(          XKB_KEY_8, ( xkb_keysym_t ) '*',                     7),
	TAGKEYS(          XKB_KEY_9, ( xkb_keysym_t ) '(',                     8),
	{ MODKEY|WLR_MODIFIER_SHIFT, ( xkb_keysym_t ) 'A',          restart,        {0} },
	{ MODKEY|WLR_MODIFIER_SHIFT, ( xkb_keysym_t ) 'Q',          quit,           {0} },
